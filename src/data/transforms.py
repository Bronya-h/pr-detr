...
try:
    from torchvision import datapoints # torchvision<=0.15.0
except:
    from torchvision import tv_tensors as datapoints # torchvision>=0.16.0
...
try:
    ...
    # from torchvision.transforms.v2  import ToTensor as ToImageTensor
